...
- [ ] Task: Create local-only infrastructure
    - [ ] Initialize `local_only/` and subfolders (`conductor/`, `context/`, `docs/`).
- [ ] Task: Refactor Path Logic
...
- [ ] Task: Categorize and Move Artifacts
...
- [ ] Task: Conductor - Auto-Review & Remediation 'Deep Scrub & Humanization'
...
- [ ] Task: Conductor - Auto-Review & Remediation 'High-Rigor Audit & Citation'
...
- [ ] Task: Conductor - Auto-Review & Remediation 'Clean-Room Verification'

## Phase 6: Final Loop Verification
- [ ] Task: Final Systemic Review
    - [ ] Perform one last full-repository review to ensure no artifacts were missed and the "clean room" state is stable.
- [ ] Task: Conductor - Auto-Review & Remediation 'Final Loop Verification'
