...
def generate_parameter_table(run_dir: Path, output_dir: Path) -> None:
    ...
    print(f"Generating parameter table...")
    
    # Template - will be populated from actual model runs
    headers = ['parameter', 'module', 'mean', 'sd', 'ci_lower', 'ci_upper', 
               'distribution', 'source', 'quality']
    
    # Example data (replace with actual posterior samples)
    rows = [
        ['baseline_testing_uptake', 'A', '0.52', '0.02', '0.48', '0.56', 
         'Beta', 'Ettema et al. 2021', 'Moderate'],
        ['deterrence_elasticity', 'A', '0.18', '0.035', '0.11', '0.25', 
         'Beta', 'McGuire et al. 2019', 'Low'],
        ['moratorium_effect', 'A', '0.15', '0.04', '0.07', '0.23', 
         'Beta', 'Taylor et al. 2021', 'Very Low'],
        ['adverse_selection_elasticity', 'C', '0.08', '0.04', '0.00', '0.16', 
         'Normal', 'Hersch & Viscusi 2019', 'Low'],
        ['demand_elasticity_high_risk', 'C', '-0.22', '0.08', '-0.38', '-0.06', 
         'Normal', 'Armstrong et al. 2020', 'Low'],
        ['baseline_loading', 'C', '0.15', '0.06', '0.03', '0.27', 
         'Normal', 'FSC Moratorium 2019', 'Very Low'],
        ['family_history_sensitivity', 'D', '0.68', '0.03', '0.62', '0.74', 
         'Beta', 'Tabor et al. 2018', 'Moderate'],
        ['proxy_substitution_rate', 'D', '0.40', '0.10', '0.20', '0.60', 
         'Beta', 'Lowenstein 2021', 'Very Low'],
        ['pass_through_rate', 'E', '0.75', '0.05', '0.65', '0.85', 
         'Beta', 'Finkelstein et al. 2019', 'Moderate'],
        ['research_participation_elasticity', 'F', '-0.10', '0.03', '-0.16', '-0.04', 
         'Normal', 'Blevins et al. 2020', 'Low'],
        ['enforcement_effectiveness', 'Enforcement', '0.50', '0.16', '0.19', '0.81', 
         'Beta', 'FSC Moratorium 2019', 'Very Low'],
        ['complaint_rate', 'Enforcement', '0.02', '0.014', '0.00', '0.05', 
         'Beta', 'Taylor et al. 2021', 'Very Low'],
    ]
...
def generate_policy_comparison_table(run_dir: Path, output_dir: Path) -> None:
    ...
    print(f"Generating policy comparison table...")
    
    headers = ['policy', 'testing_uptake', 'uptake_ci_lower', 'uptake_ci_upper',
               'premium_change', 'premium_ci_lower', 'premium_ci_upper',
               'welfare_impact', 'welfare_ci_lower', 'welfare_ci_upper',
               'qalys_gained', 'fiscal_impact']
    
    # Example data (replace with actual model outputs)
    rows = [
        ['status_quo', '0.52', '0.48', '0.56', '0.00', '-0.02', '0.02', 
         '0', '-50000', '50000', '0', '0'],
        ['moratorium', '0.58', '0.54', '0.62', '0.02', '0.00', '0.04', 
         '150000', '50000', '250000', '120', '-50000'],
        ['statutory_ban', '0.62', '0.58', '0.66', '0.05', '0.02', '0.08', 
         '250000', '150000', '350000', '180', '-80000'],
    ]
...
def generate_voi_table(run_dir: Path, output_dir: Path) -> None:
    ...
    print(f"Generating VOI results table...")
    
    headers = ['parameter_group', 'evppi', 'evppi_ci_lower', 'evppi_ci_upper',
               'priority_rank', 'research_recommendation']
    
    # Example data
    rows = [
        ['deterrence_elasticity', '50000', '30000', '70000', '1', 'High priority for empirical study'],
...
def generate_sensitivity_table(run_dir: Path, output_dir: Path) -> None:
    ...
    print(f"Generating sensitivity analysis table...")
    
    headers = ['parameter', 'base_value', 'low_value', 'high_value',
               'welfare_base', 'welfare_low', 'welfare_high', 'sensitivity_index']
    
    # Example data
    rows = [
        ['deterrence_elasticity', '0.18', '0.10', '0.26', '150000', '100000', '200000', '0.67'],
        ['adverse_selection_elasticity', '0.08', '0.04', '0.12', '150000', '120000', '180000', '0.40'],
...
def generate_evidence_quality_table(run_dir: Path, output_dir: Path) -> None:
    ...
    print(f"Generating evidence quality table...")
    
    headers = ['module', 'moderate_count', 'low_count', 'very_low_count',
               'total_parameters', 'percent_moderate', 'data_sources']
    
    rows = [
        ['Module A (Behavior)', '1', '1', '1', '3', '33%', 'Ettema 2021, McGuire 2019, Taylor 2021'],
...
def main():
    ...
    parser.add_argument('--output', type=str, default='outputs/tables/v1.0',
