    ...
    def validate_entry(self, entry: dict) -> ValidationResult:
        ...
        if 'author' in entry:
            ...
            if ' and ' in author:
                ...
                if len(authors) > 10:
                    result.add_suggestion(f"Consider using 'and others' for >10 authors")
...
def main():
    ...
    parser.add_argument('--bib-file', default='context/references.bib',
                       help='Path to BibTeX file')
    parser.add_argument('--fix', action='store_true',
                       help='Auto-fix common issues')
    parser.add_argument('--doi-check', action='store_true',
                       help='Validate DOIs by resolving them (slow)')
    parser.add_argument('--report', action='store_true',
                       help='Generate detailed markdown report')
    parser.add_argument('--output', default='docs/REFERENCE_VALIDATION_REPORT.md',
