...
from .parameters import ModelParameters, PolicyConfig, HyperParameters
from .rng import RNGManager
from .module_a_behavior import (
    compute_testing_uptake,
    compute_policy_effect as behavior_policy_effect,
...
from .module_d_proxy import (
    compute_proxy_substitution_effect,
...
def evaluate_policy_sweep(
    ...
    # Initialize RNG
    rng = RNGManager(base_seed=hyper_params.random_seed)
...
def compare_policies(
    ...
    for policy_name, result in results.items():
        ...
        comparisons[policy_name] = {
            ...
            'compliance_change': (
                result.compliance_rate - baseline.compliance_rate
            ),
        }
