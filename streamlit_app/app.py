...
moratorium_belief = st.sidebar.select_slider(
    "Industry Trust (Moratorium Effect)",
    options=["Low", "Standard", "High"],
    value="Standard"
)
...
policy_label = st.selectbox(
    "Select Policy Regime to Evaluate:",
...
if "result" in st.session_state:
    ...
    with t1:
        ...
        with col_left:
            ...
            comp_names = ["Consumer Surplus", "Insurer Profits", "Health Benefits", "Research Externalities"]
            ...
            fig = go.Figure(go.Bar(
                ...
                marker_color=[STYLE["colors"]["consumer"], STYLE["colors"]["insurer"], STYLE["colors"]["health"], "#999999"]
            ))
