...
from src.model.delta_view import (
    ...
    format_delta_table,
    calculate_net_welfare_gain,
)
from src.model.scenario_analysis import load_scenarios, evaluate_scenario
...
if "delta_analysis" in st.session_state:
    ...
    st.divider()
    st.subheader(f"📊 Delta Analysis (Baseline: {baseline_options.get(baseline_key, baseline_key)})")
