...
from src.model.module_d_proxy import optimize_underwriting, compute_risk_score, compute_family_history_accuracy
...
def test_evaluate_multiple_policies_coverage():
    from src.model.module_a_behavior import evaluate_multiple_policies, get_standard_policies, compute_perceived_penalty
    params = get_default_parameters()
    ...
    res = evaluate_multiple_policies(params, policies, n_individuals=10, individual_characteristics=char)
    ...
    p_no_caps = PolicyConfig(name="no_caps", description="No caps", allow_genetic_test_results=False, sum_insured_caps=None)
