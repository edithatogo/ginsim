...
class TestExpectedPenalty:
    ...
    def test_penalty_positive(self):
        ...
        penalty = compute_expected_penalty(penalty_max=1000000, detection_probability=0.5, enforcement_effectiveness=0.5)
        assert penalty > 0.0
...
class TestComplianceDecision:
    ...
    def test_compliance_decreases_with_benefit(self):
        ...
        compliance_low_benefit = compute_compliance_decision(violation_benefit=0.2, expected_penalty=0.5)
        compliance_high_benefit = compute_compliance_decision(violation_benefit=0.8, expected_penalty=0.5)
